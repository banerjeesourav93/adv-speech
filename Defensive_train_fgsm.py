...
from attack_fgsm import PGDAttack
...
parser.add_argument('--eps', '--epsilon', default= 200, type=float, help='l infinity boundary')
...
parser.add_argument('--save-folder', default='defense_modelsi_temp/', help='Location to save epoch models')
parser.add_argument('--model-path', default='defense_models_temp/deepspeech_final.pth',
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        attack = PGDAttack(model = model,audio_conf = audio_conf , device =  device ,optimizer_type = 'dam', adv_lr = args.adv_lr , momentum = args.momentum)
