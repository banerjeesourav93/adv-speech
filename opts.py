def add_decoder_args(parser):
    ...
    beam_args.add_argument('--lm_path', default='./lm/lm.binary', type=str,
    ...
    beam_args.add_argument('--cutoff-prob', default=0.99, type=float,
                           help='Cutoff probability in pruning,default 0.99, no pruning.')
