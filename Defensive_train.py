...
if __name__ == '__main__':
    ...
    loss_results, cer_results, wer_results = torch.tensor([]), torch.zeros([]), torch.zeros([])
    best_wer = None
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        attack = PGDAttack(model = model,audio_conf = audio_conf , device =  device , iterations = args.adv_iterations,optimizer_type = 'Adam', adv_lr = args.adv_lr , momentum = args.momentum)
