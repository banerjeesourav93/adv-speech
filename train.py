...
parser.add_argument('--train-manifest', metavar='DIR',
                    help='path to train manifest csv', default='data/libri_train_manifest_small_temp.csv')
...
parser.add_argument('--checkpoint-per-batch', default=15, type=int, help='Save checkpoint per batch. 0 means never save')
...
parser.add_argument('--save-folder', default='models_temp/', help='Location to save epoch models')
parser.add_argument('--model-path', default='models_temp/deepspeech_final.pth',
