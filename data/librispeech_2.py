...
parser.add_argument("--target-dir", default='data/LibriSpeech_dataset/', type=str, help="Directory to store the dataset.")
parser.add_argument('--sample-rate', default=16000, type=int, help='Sample rate')
parser.add_argument('--files-to-use', default="dev-clean.tar.gz,test-clean.tar.gz", type=str, help='list of file names to download')
...
def main():
    print("saving to {}".format(args.target_dir))
    ...
    for split_type, lst_libri_urls in LIBRI_SPEECH_URLS.items():
        ...
        #for url in lst_libri_urls:
            ...
            #dl_flag = False
            #tarfile_path = os.path.join(split_dir,url.split("/")[-1])
